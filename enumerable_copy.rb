...
# sedans=car_lot.select do |sedan|
#   sedan[:type] == "Sedan"
# end

# suvs = car_lot.select do |suv|
#   suv[:type] == "SUV"
# end

# puts "I checked the car lot and we have #{sedans.count} sedans"
# puts "Here's the manufacturers for each of those sedans:"
# sedans.each do |sedan|
#   puts "#{sedan[:company]}"
# end
# puts "We also have #{suvs.count} SUVs. They're made by:"
# suvs.each { |suv| puts "#{suv[:company]}"}
...
# tw_handles = tsl_team.collect do |handle|
# puts "@#{handle[:twitter]}"
# end
...
clubs = [club_lumen, club_paris, club_cubby]

clubs.each do |bro_check|
  puts "Entering the club..."
  if bro_check.detect do |who_dat|
        who_dat=="bro"
    end
